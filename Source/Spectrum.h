...
public:
    ...
    void newOpenGLContextCreated() override
    {
        ...
        /* ----------------------------------
            Index of attribute 
            how many values it has, called size here and dim in max I think
            Type 
            Should Normalize?
            Stride --  should always be the same as size * type?
            starting offset
        ...
        */
        ...
        openGLContext.extensions.glBindBuffer (GL_ARRAY_BUFFER, yVBO);
        openGLContext.extensions.glVertexAttribPointer (1, 1, GL_FLOAT, GL_FALSE, sizeof(GLfloat), NULL); // notice both are null because tehy reference the position attrib, not normal
