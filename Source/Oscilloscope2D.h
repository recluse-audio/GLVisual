...
private:
    ...
    */
    void createShaders()
    {
        ...
        StringRef filePath = "C:/ProgramData/Recluse-Audio/Shaders/Oscilloscope2D.frag";
        auto file = File(filePath);

        if (file.existsAsFile())
        {
            //DBG("exists");
            fragmentShader =  file.loadFileAsString();
            DBG(fragmentShader);
        }

       // fragmentShader = BinaryData::Oscilloscope2D_frag;
